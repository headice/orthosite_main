          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                Оператор может получить о посетителях веб-сайта https://Наш_Мэйл
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                доступность в сети интернет по сетевому адресу https://Наш_Мэйл
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                Пользователь – любой посетитель веб-сайта https://Наш_Мэйл
              </p>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                электронной почты beautydvmoroz@yandex.ru с пометкой «Отказ от
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                через специальные формы, расположенные на сайте https://Наш_Мэйл
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                https://Наш_Мэйл с пометкой «Актуализация персональных данных».
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                https://Наш_Мэйл с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
            </div>
          ...
          <section className="space-y-4 mb-2">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                Интернет по адресу https://Наш_Мэйл/privacy
              </p>
            </div>
          </section>
