import React, { useEffect } from "react"; // ← добавь useEffect здесь
...
const Politika = () => {
  ...
  // Добавь этот эффект для скролла наверх при открытии страницы
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div
      id="privacy-policy"
      className="min-h-screen bg-blue-600 text-white flex justify-center px-4 py-10 scroll-mt-20"
      style={{
    ...
    >
      {/* Карточка с размытым прозрачным фоном */}
      <div className="max-w-5xl w-full bg-white/15 backdrop-blur-md border border-white/30 rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 overflow-y-auto">
        <h1 className="text-center text-3xl font-semibold mb-10 font-[montserrat]">
        ...
        <div className="space-y-10 leading-relaxed text-sm sm:text-base">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              Михайдаровой Натальей Владимировной. (далее – Оператор).
            </p>

            <div className="space-y-2">
              <h3 className="font-semibold">1.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">1.2.</h3>
              <p>
                ...
                Оператор может получить о посетителях веб-сайта https://go-vector.ru/
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.2.</h3>
              <p>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                доступность в сети интернет по сетевому адресу https://go-vector.ru/
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">2.4.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.5.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.6.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.7.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.8.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.9.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.10.</h3>
              <p>
                Пользователь – любой посетитель веб-сайта https://go-vector.ru/
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">2.11.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.12.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.13.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">2.14.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="font-semibold">3.1. Оператор имеет право:</h3>
              <ul className="list-disc list-inside space-y-2 pl-1 sm:pl-4">
                <li>
            ...
            <div className="space-y-3">
              <h3 className="font-semibold">3.2. Оператор обязан:</h3>
              <ul className="list-disc list-inside space-y-2 pl-1 sm:pl-4">
                <li>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">4.3.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.3.</h3>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.5.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.6.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.7.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.8.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.8.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.8.2.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.8.3.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">5.8.4.</h3>
              <p>
                Согласие на обработку персональных данных, разрешенных для
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.2.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.3.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.4.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.5.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.6.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">6.7.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">7.1.</h3>
              <p>Цель обработки персональных данных Пользователя:</p>
              <ul className="list-disc list-inside space-y-2 pl-1 sm:pl-4">
                <li>консультация по продаже услуги/товара.</li>
              </ul>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">7.2.</h3>
              <p>
                ...
                электронной почты vectorzdorovya@yandex.ru с пометкой «Отказ от
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">7.3.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="font-semibold">8.1.</h3>
              ...
              <ul className="list-disc list-inside space-y-2 pl-1 sm:pl-4">
                <li>
                  ...
                  сайтов, то здесь можно указать Федеральный закон &quot;Об
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">8.2.</h3>
              <p>
                ...
                через специальные формы, расположенные на сайте https://go-vector.ru/
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">8.3.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.2.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.3.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.4.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.5.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.6.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">9.7.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">10.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                https://go-vector.ru/ с пометкой «Актуализация персональных данных».
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">10.4.</h3>
              <p>
                ...
                https://go-vector.ru/ с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">10.5.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">10.6.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">10.7.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">10.8.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">10.9.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">11.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">11.2.</h3>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">12.1.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">12.2.</h3>
              <p>
          ...
          <section className="space-y-4 mb-2">
            <h2 className="text-2xl font-bold">14. Заключительные положения</h2>

            <div className="space-y-2">
              <h3 className="font-semibold">14.1.</h3>
              <p>
                ...
                https://go-vector.ru/privacy-policy
              </p>
            </div>

            <div className="space-y-2">
              <h3 className="font-semibold">14.2.</h3>
              <p>
            ...
            <div className="space-y-2">
              <h3 className="font-semibold">14.3.</h3>
              <p>
                Актуальная версия Политики в свободном доступе расположена в сети
                Интернет по адресу https://go-vector.ru/privacy-policy
              </p>
            </div>
          </section>
  ...
  <button
    ...
    className="rounded-2xl border border-white/40 px-10 py-4 mt-2 font-semibold uppercase tracking-wide transition hover:bg-white/20 hover:border-white/60"
  >
