...
const speakers = [
  { name: "Иванов Аркадий Николаевич", role: "г. Москва", desc: "Хирург, врач ортопед, травматолог. Техник-ортопед прошедший стажировку в США И Германии. Заведующий лабораторией ортезирования стопы ФГУП ЦИТО.", image: arc },
  { name: "Петров Дмитрий Олегович", role: "г. Москва", desc: "Инженер-биомеханик, заместитель заведующего лабораторией ортезирования стопы ФГУП ЦИТО.", image: pet },
];
