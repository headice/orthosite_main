    ...
    <div className='animate-fadeUp scroll-smooth'>
      <section id="who" className="rounded-[32px] p-8 scroll-mt-10">
        ...
        <div
          ...
          style={{ gridTemplateColumns: "repeat(4, 350px)" }}
        >
          ...
          <div className="order-1 md:order-none border border-white/80 shadow-white/10 bg-gradient-to-br from-[#122C58] via-[#1D478F] to-[#122C58]
                          mx-auto p-6 rounded-3xl border border-white/20 shadow-lg mb-6 md:mb-0">
          ...
          {/* 2 — фото */}
          <div className="order-2 md:order-none h-[200px] w-full max-w-[350px] mx-auto rounded-3xl overflow-hidden mb-6 md:mb-0">
          ...
          {/* 4 — фото */}
          <div className="order-4 md:order-none h-[200px] w-full max-w-[350px] mx-auto rounded-3xl overflow-hidden mb-6 md:mb-0">
            <img src={whoBottom} className="w-full h-full object-cover" alt="Фото 2" />
          </div>

          {/* 5 — фото (на мобильном идёт после текста, поэтому order-6) */}
          <div className="order-6 md:order-none h-[200px] w-full max-w-[350px] mx-auto rounded-3xl overflow-hidden mb-6 md:mb-0">
          ...
          <div className="order-8 md:order-none 
              ...
              {/* 8 — текст */}
              <div className="order-7 md:order-none border border-white/80 shadow-white/10 bg-gradient-to-br from-[#122C58] via-[#1D478F] to-[#122C58] w-full max-w-[350px]
