      ...
      */}
      <div className="relative z-10 w-full pt-24 md:pt-20 pb-6 lg:pb-0">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {/* левый спикер */}
            <div className="w-64 text-center lg:text-right pt-4 lg:pt-8">
            ...
            <div className="w-64 flex flex-col items-center lg:items-start text-center lg:text-left pt-4 lg:pt-8">
              <h3 className="text-2xl font-semibold">
